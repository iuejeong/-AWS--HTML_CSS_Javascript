class ModalEvent {
    ...
    //     const modalOkButton = document.querySelector(".modal-ok-button")
    //     modalOkButton.onclick = () => {
    //         const inputValue = document.querySelector(".modal-message").value;
    //         TodoService.getInstance().todoList[modifyIndex].todoContent = inputValue;
    //         TodoService.getInstance().updateLocalStorage();
    //         ModalService.getInstance().closeModal();
    //     }
    // }
...
class ModalService {
    ...
    //         </div>
    //         <div class="modal-main">
    //             <input value="${todoObj.todoContent}" class="modal-message"></input>
    //         </div>
    //         <div class="modal-footer">
    //             <button type="button" class="modal-ok-button">확인</button>
    //             <button type="button" class="modal-cancel-button">취소</button>
