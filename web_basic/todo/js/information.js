class InformationEvent {
    ...
    addEventAboutMeModifyClick() {
        ...
        aboutMeModifyButton.onclick = () => {
            ...
            infoInputContainers.forEach(infoInputContainers => {
                infoInputContainers.querySelector(".info-input").disabled = false;
            });
        }
    }
    ...
    // addEventModifyInput() {
    //     const infoInputContainers = document.querySelectorAll(".info-input-container");
    //     const infoIntroduce = document.querySelector(".info-introduce");
    //     const infoValue = infoInputContainers.querySelector(".info-input").value;
    //     infoInputContainers.forEach(infoInputContainers => {
    //     this.userInfo = infoInputContainers.querySelector(".info-input").value;
    //     console.log(this.userInfo);
    //     });
    // }
}

    // addEventInformations() {
    //     const mButton = document.querySelector(".m-aboutme");
    //     const sButton = document.querySelector(".s-aboutme")
    //     const inputContainer = document.querySelectorAll(".info-input");
    //     mButton.onclick = () => {
    ...
    //         if(sButton.classList.contains("button-hidden")){
    //             sButton.classList.remove("button-hidden");
    //         }
    //     }
    ...
    //             sButton.classList.add("button-hidden");
    //     }
