class TodoEvent {
    ...
    // addEventModifyTodoClick() {
    //     const updateButtons = document.querySelectorAll(".content-footer .modify-button");
...
class TodoService {
    ...
    addTodo() {
        ...
        const todoObj = {
            todoDate: `${nowData.getFullYear()}.${nowData.getMonth() + 1}.${nowData.getDate()}(${convertDay(nowData.getDay())})`,
