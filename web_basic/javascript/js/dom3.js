/**
 * 1. 추가 버튼 클릭 시, input에 들어있는 value의 값을 list에 추가
 * 2. 확인 버튼 클릭 시, todo-content의 색상을 red로 변경, text-decoration에 취소선 적용
 * 3. 확인 버튼 다시 클릭 시, todo-content의 색상을 black으로 변경, text-decoration에 취소선 미적용
 * 
 */
